...
void MainWindow::on_pushButton_clicked()
{
    ...
    else
    {
        ...
        Camera mainCamera = Camera(400, 400, Point3f(0, 0.5, 12), Point3f(0, 0, 0), Vector3f(0, 1, 0));
        Scene scene;
        scene.mCamera = mainCamera;

        PointLight mLight1 = PointLight(Point3f(-2, 4, 2), Color3f(255, 255, 255));
        scene.mLightList.push_back(mkU<PointLight>(mLight1));
        ...
        LambertMaterial emissive_material = LambertMaterial(Color3f(1, 1, 1));
